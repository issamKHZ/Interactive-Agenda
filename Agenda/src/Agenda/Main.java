...
public class Main {	
	...
	public static Agenda initializeFullAgenda() {
		...
		tasks.add(new Task("Breakfast time", LocalTime.of(1, 00), LocalTime.of(1, 30), States.UNDONE, false, false));
		...
		tasks.add(new Task("Dinner time", LocalTime.of(00, 01), LocalTime.of(00, 45), States.UNDONE, false, false));
